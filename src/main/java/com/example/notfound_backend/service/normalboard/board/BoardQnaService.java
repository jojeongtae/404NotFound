...
public class BoardQnaService {
    ...
    public List<BoardDTO> findAll() {
        List<BoardQnaEntity> entityList = boardQnaDAO.findAllByStatus(Status.VISIBLE);
        List<BoardDTO> boardDTOList = new ArrayList<>();
        for(BoardQnaEntity entity : entityList){
    ...
    public List<BoardDTO> findAllByUser(String username) {
        List<BoardQnaEntity> entityList = boardQnaDAO.findAllBoardsByUser(username);
        List<BoardDTO> boardDTOList = new ArrayList<>();
        for(BoardQnaEntity entity : entityList){
            boardDTOList.add(convertToBoardDTO(entity));
        }
    ...
    public List<BoardDTO> findAllByAdmin(String username) {
        ...
        List<BoardQnaEntity> entityList = boardQnaDAO.findAllBoards();
        List<BoardDTO> boardDTOList = new ArrayList<>();
        for(BoardQnaEntity entity : entityList) {
            boardDTOList.add(convertToBoardDTO(entity));
        }
    ...
    private BoardDTO convertToBoardDTO(BoardQnaEntity entity) {
    ...
    public BoardDTO updateBoardStatus(Integer id, BoardDTO boardDTO) { // boardDTO(author,status)
        ...
        BoardQnaEntity entity = boardQnaDAO.findById(id).orElseThrow(()->new RuntimeException("Board not found"));
    ...
    public List<BoardRankingResponse> getQnaTop5ByRecommendInLast7Days(){
        List<BoardRankingDTO> dtos = boardQnaDAO.getTop5ByRecommend();
